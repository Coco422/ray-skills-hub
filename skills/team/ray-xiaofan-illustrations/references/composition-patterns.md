...
- 动作要服务核心意思，不要为了怪而怪。
- 小反可以穿衣服、戴帽子、拿道具作为场景扮演层，但必须保留白色圆角身体、体内红斜线、头顶黑色回转箭头。

## 反复刻规则

v0.1.0 不收录旧 `assets/examples/`。不要依赖旧示例图做默认风格判断；需要校准时读取 `style-dna.md` 和 `xiaofan-ip.md`。旧案例里的小黑外形不是当前默认角色。
...
同类主题也要换新隐喻。例如“承接路径”不一定画路线，可以画小反把内容尾巴接到门把手；“一鱼多吃”不一定画鱼，可以画小反把一个纸团压成几种形状。
